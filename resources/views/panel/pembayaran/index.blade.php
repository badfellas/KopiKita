...
<style>
                                ...
                                <table class="table" id="pembayaranTable">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 15%;">Total</th>
                                            <th style="width: 20%;">Metode</th> <!-- Mengubah width menjadi lebih besar -->
    ...
    <style>
        /* Menambahkan CSS untuk mengatur wrapping teks pada kolom metode */
        #pembayaranTable td {
            white-space: normal !important; /* Memaksa text untuk wrap */
            word-wrap: break-word;
        }
        
        /* Mengatur lebar minimum untuk kolom metode */
        #pembayaranTable th:nth-child(5),
        #pembayaranTable td:nth-child(5) {
            min-width: 180px;
        }
    </style>
