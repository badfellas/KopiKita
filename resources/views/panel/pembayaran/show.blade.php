...
@section('content')
    ...
    <script>
        // Mengambil nilai metode pembayaran dari elemen dengan id "metodeSpan"
        ...
        // Ubah tampilan metode pembayaran sesuai dengan warna yang ditentukan
        document.getElementById('metodeSpan').innerHTML = '<span class="badge ' + metodeColor + '">' + metodePembayaran + '</span>';
    </script>
@endsection
