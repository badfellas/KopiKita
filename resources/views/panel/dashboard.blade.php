                    ...
                    <div class="col-12">
                        <div class="card card-md">
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-10">
                                        <h3 class="h1">Kelompok Komputasi awan Ummar Bin Affan</h3>
                                        <div class="markdown text-muted">
                                            Hasil akhir projek kami yang mengangkat judul QR Code Ordering System atau Contactless Ordering System
                                            Web kami menerapkan Cloud Computing yang dimana bisa diakses menggunakan internet. Bismillah Lancar :D
                                        </div>
                                        <div class="mt-3">
        ...
        document.addEventListener("DOMContentLoaded", function() {
            window.ApexCharts && new ApexCharts(document.getElementById("chart-pemesanan"), {
                ...
                series: [{
                    ...
                    {
                        name: "Selesai",
                        data: {!! json_encode(array_values($selesaiData)) !!}
                    }
                ],
                xaxis: {
                    type: "category",
